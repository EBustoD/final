...
class visualizar_datos_seleccionados : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btnBorrar -> {
                try {
                    showtDialog(
                        context.getResources().getString(R.string.mesaje_borrado),
                        context.getResources().getString(R.string.cuidado)
                    )
    ...
    private fun borrarDato() {
        ...
        val dirPathConsumo =
            File(getExternalFilesDir(Environment.DIRECTORY_DCIM).toString() + File.separator.toString() + firmaFichero + File.separator.toString() + "consumo.txt")
        dirPathConsumo.delete()
        //Borramos fichero numero serie
        val dirPathSerie =
            File(getExternalFilesDir(Environment.DIRECTORY_DCIM).toString() + File.separator.toString() + firmaFichero + File.separator.toString() + "numeroSerie.txt")
        dirPathSerie.delete()
        ...
        //Borramos Ruta DCIM
        val dirPathImgConsu =
            File(getExternalFilesDir(Environment.DIRECTORY_DCIM).toString() + File.separator.toString() + firmaFichero + File.separator.toString() + "consumo_" + firmaFichero + ".jpg")
        val dirPathImgSerie =
            File(getExternalFilesDir(Environment.DIRECTORY_DCIM).toString() + File.separator.toString() + firmaFichero + File.separator.toString() + "serie_" + firmaFichero + ".jpg")
        dirPathImgConsu.delete()
        dirPathImgSerie.delete()

        //Borramos la carpeta
        val dirPath =
            File(getExternalFilesDir(Environment.DIRECTORY_DCIM).toString() + firmaFichero + File.separator.toString())
        dirPath.delete()
